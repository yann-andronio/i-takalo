...
export default function SearchBar({ onChangeText }: SearchBarProps) {
  return (
    <View className="flex-1 flex-row items-center">
      ...
      <View className="flex-row items-center bg-[#F9F9F9] w-full border border-[#C2C2C2] rounded-xl px-3 shadow-md">
        ...
        <TextInput
          ...
          className="flex-1 bg-[#F9F9F9] text-black ml-2 text-base py-3" 
