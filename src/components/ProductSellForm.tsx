...
const PRODUCT_CATEGORIES = ['T_SHIRT', 'PANTALON', 'CHAUSSURE','ROBE',  'VESTE'];
    ...
    return (
        ...
        >
          ...
          <TouchableOpacity
                        ...
                        <View className="flex-row flex-wrap  gap-3 items-center">
                            {PRODUCT_CATEGORIES.map((category) => (
                                <TouchableOpacity
                                    ...
                                    `}
                                >
                                    <Text className={`text-center font-bold ${value === category ? 'text-white' : 'text-black'}`}>
                                        {category.replace('_', ' ')}
                                    </Text>
                                </TouchableOpacity>
                            ))}
            ...
            <TouchableOpacity
                className={`rounded-full p-4 items-center mt-5 ${loading ? 'bg-[#FEF094]' : 'bg-[#FEF094]'}`}
