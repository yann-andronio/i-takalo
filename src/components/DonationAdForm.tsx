...
export default function DonationAdForm() {
    ...
    const handleAddDonation = (data: FormData): void => {
    ...
    return (
        ...
        >
            ...
            <View className="mb-5">
                ...
                {/* cat */}
                <Text className="text-base font-bold mb-2">Catégorie</Text>
                <TextInput
                ...
                {/* Adresse */}
                <Text className="text-base font-bold mb-2 mt-5">Adresse</Text>
                <TextInput
